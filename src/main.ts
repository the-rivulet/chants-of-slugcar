...
add("Can't", "No", "Can");
add("Edible", "Can", "Eat");
add("Invincible", "Can't", "Kill");
add("Understandable", "Can", "Understand");
add("Won't", "No", "Will");
add("World", "Big", "Place");
...
add("Zero", "No");
// Plurals
for(let i of ["Ancient", "Carnivore", "Corpse", "Creature", "Emotion", "Explosion", "Explosive Spear", "Friend", "Grenade", "Iterator", "Killer", "Lizard", "Number", "Pearl", "Place", "Plant", "Predator", "Object", "Owner", "Question", "Rock", "Scavenger", "Slugcat", "Slugpup", "Snail", "Spear", "Weapon"]) add(i + "s", i, "Plural");
