...
add("You", "No", "Me");
// Plurals
for (let i of ["Ancient", "Carnivore", "Corpse", "Creature", "Explosion", "Explosive Spear", "Grenade", "Iterator", "Object", "Owner", "Question", "Rock", "Scavenger", "Spear", "Survivor", "Weapon"])
    add(i + "s", i, "And");
